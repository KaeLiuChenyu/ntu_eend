...
from ntu_eend.scr.nnet.enh.loss.criterions.tf_domain import FrequencyDomainMSE
...
class DiarSepSpeech:
    ...
    def __init__(
        ...
        # 1. Build Enh model
        diar_enh_model, diar_enh_train_args = EENDSSTask.build_model_from_file(
...
def inference(
    ...
    loader = EENDSSTask.build_streaming_iterator(
        data_path_and_name_and_type,
        dtype=dtype,
        batch_size=batch_size,
        key_file=key_file,
        num_workers=num_workers,
        preprocess_fn=EENDSSTask.build_preprocess_fn(
            diarsep_speech.diar_enh_train_args, False
        ),
        collate_fn=EENDSSTask.build_collate_fn(
            diarsep_speech.diar_enh_train_args, False
        ),
    ...
    # # ------------------check dataloader-------------------#
    # print("#---------------------TEST-------------------------#")
    # print("Test Dataloader in /bin/diar_enh_inference:inference")
    # print("#--------------------------------------------------#")
    # for data in loader:
    #     print("UID:", data[0])
    #     for key in data[1]:
