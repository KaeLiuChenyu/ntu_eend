...
import sys
sys.path.append(r'/content/drive/MyDrive/EEND-SS')
...
def main():
    ...
    with open(args.out_rttm_file, "w") as wf:
        for key in scp_reader.keys():
            ...
            # print("args.frame_shift",args.frame_shift)
            # print("args.subsampling", args.subsampling)
            # print("sampling_rate", sampling_rate)


            #factor = args.frame_shift * args.subsampling / sampling_rate
            factor = args.frame_shift * args.subsampling / sampling_rate / 2
