...
from ntu_eend.scr.dataio.fileio.npy_scp import NpyScpReader
from ntu_eend.scr.dataio.fileio.rand_gen_dataset import FloatRandomGenerateDataset
from ntu_eend.scr.dataio.fileio.rand_gen_dataset import IntRandomGenerateDataset
from ntu_eend.scr.dataio.fileio.read_text import load_num_sequence_text
from ntu_eend.scr.dataio.fileio.read_text import read_2column_text
from ntu_eend.scr.dataio.fileio.rttm import RttmReader
from ntu_eend.scr.dataio.fileio.sound_scp import SoundScpReader
from ntu_eend.scr.utils.sized_dict import SizedDict
...
def SpeakerSpaceReader(spksp):
    return torch.load(spksp)
...
DATA_TYPES = {
    ...
    "emb": dict(
        func=SpeakerSpaceReader,
        kwargs=[],
        help="load speaker space embeddings"
    )
}
